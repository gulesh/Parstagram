...
class FeedViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, MessageInputBarDelegate{
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        let comments = (post["comments"] as? [PFObject]) ?? [] //nil operator if left side nil det it equal to [] (what is on thr right
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let post = posts[indexPath.section] // because now we have created section in the function above
